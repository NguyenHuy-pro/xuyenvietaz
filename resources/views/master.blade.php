...
<body id="xv_body">
    {{--page Content--}}
    <div id="xv_master" class="xv-master container-fluid">
        <div class="row">
            <div id="xv_master_header" class="xv-bg-white col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
                @yield('xv_master_header')
            </div>
        </div>
        <div class="row">
            <div id="xv_master_body" class="xv-master-body xv-bg-white col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
                @yield('xv_master_body')
            </div>
        </div>

        <div class="row">
            <div id="xv_master_body" class="xv-bg-white col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
                @yield('xv_master_footer')
            </div>
        </div>
    </div>
{{--jQuery--}}
